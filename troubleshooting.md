...
2. There are many reasons that can result in the error below when cloning or pulling a GitHub repository:
   ...
   ```console
   $ git remote -v
   course-assignments  https://github.com/dat520-2021/assignments.git (fetch)
   course-assignments  https://github.com/dat520-2021/assignments.git (push)
   origin  https://github.com/dat520-2021/YOUR_USERNAME-labs.git (fetch)
   origin  https://github.com/dat520-2021/YOUR_USERNAME-labs.git (push)
   ```

   If this is the case, change the remote's URL to use ssh by running (remember to replace YOUR_USERNAME with your own):

   ```console
   git remote set-url course-assignments git@github.com:dat520-2021/assignments.git
   git remote set-url origin git@github.com:dat520-2021/YOUR_USERNAME-labs.git
   ```
   ...
   origin  git@github.com:dat520-2021/YOUR_USERNAME-labs.git (fetch)
   origin  git@github.com:dat520-2021/YOUR_USERNAME-labs.git (push)
   ```
